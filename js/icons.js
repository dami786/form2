/* Sport icons – line art with red accents (JerseyBird Paperform style) */
const SPORT_ICONS = {
  soccer: `<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M32 70 L28 76" stroke="#ff3b3b" stroke-width="3" stroke-linecap="round"/>
    <circle cx="72" cy="28" r="3" fill="#ff3b3b"/>
  </svg>`,
  ...
  basketball: `<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M58 18 L65 25" stroke="#ff3b3b" stroke-width="4" stroke-linecap="round"/>
  ...
  hockey: `<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M24 78 L20 84" stroke="#ff3b3b" stroke-width="4" stroke-linecap="round"/>
    <path d="M40 35 L50 32 L48 42 L38 45 Z" fill="#ff3b3b" opacity="0.9"/>
  </svg>`,
  ...
  baseball: `<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <ellipse cx="42" cy="42" rx="8" ry="6" fill="#ff3b3b"/>
  </svg>`,
  ...
  esports: `<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="35" cy="48" r="3" fill="#ff3b3b"/>
    <circle cx="65" cy="48" r="3" fill="#ff3b3b"/>
  ...
  lacrosse: `<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="72" cy="58" r="8" fill="#ff3b3b"/>
  ...
  rugby: `<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <ellipse cx="55" cy="72" rx="4" ry="3" fill="#ff3b3b"/>
  </svg>`,
  ...
  football: `<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M48 62 Q55 68 52 74" stroke="#ff3b3b" stroke-width="4" stroke-linecap="round"/>
  </svg>`,
  ...
  volleyball: `<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="50" cy="42" r="4" fill="#ff3b3b"/>
  </svg>`
};
